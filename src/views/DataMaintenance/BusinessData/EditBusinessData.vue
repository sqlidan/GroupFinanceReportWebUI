<template>
    <div class="editBusinessData">
        <el-dialog :title="pageType === 'insert' ? '新增业务数据信息' : '编辑业务数据信息'" 
        v-dialogDrag
            ...
            <el-form size="mini" :model="form" ref="ruleForm" :rules="rules" label-width="100px" >
                ...
                <el-row>
                 ...
                 <el-row>
                        ...
                        <el-col :span="12">
                            <el-form-item label="业务量：" prop="volume" >
                            <!-- <el-input size="mini" v-model="form.volume" placeholder="请输入业务量"></el-input> -->
                            <el-input-number
                                placeholder="业务量"
                                v-model="form.volume"
...
import {GetBusinessDataById,CreateOrUpdateBusinessData} from 'api/DataMaintenance/BusinessData'
        ...
        return {
            ...
            rules: {
                ...
                linNO: {required: true, message: '请选择科目', trigger: 'change'},        
                 ...
                 volume: [
                    { required: true, message: '请输入业务量', trigger: 'blur' },
                ],
                 budgetType: [
    ...
    methods: {
      ...
      setComBox() {
        ...
        GetBusinessDataById(id) {
            GetBusinessDataById({id: id}).then(res => {
        ...
        save() {
            this.$refs["ruleForm"].validate((valid) => {
                if (valid) {
                    ...
                    CreateOrUpdateBusinessData(data).then(res => {
